...
public abstract class GenericTypeResolver {
    ...
    if (contextClass != null) {
      if (genericType instanceof TypeVariable) {
        ...
        if (resolvedType.hasUnresolvableGenerics()) {
          ...
          return ResolvableType.forClassWithGenerics(resolvedType.getRawClass(), generics)
              .getType();
        }
      }
    }
  ...
  public static Class<?> resolveType(Type genericType, Map<TypeVariable, Type> map) {
    return ResolvableType.forType(genericType, new TypeVariableMapVariableResolver(map))
  ...
  @SuppressWarnings("rawtypes")
  private static void buildTypeVariableMap(ResolvableType type,
    ...
    if (type != ResolvableType.NONE) {
      ...
      if (type.resolve().isMemberClass()) {
        buildTypeVariableMap(ResolvableType.forClass(type.resolve().getEnclosingClass()),
            typeVariableMap);
      }
    }
  }
